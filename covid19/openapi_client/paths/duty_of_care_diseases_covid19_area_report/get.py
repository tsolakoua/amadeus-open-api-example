...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'cityCode': typing.Union[CityCodeSchema, str, ],
...
request_query_city_code = api_client.QueryParameter(
    name="cityCode",
    style=api_client.ParameterStyle.FORM,
    schema=CityCodeSchema,
    explode=True,
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["warnings", "meta", "data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["warnings", "meta", "data", ], str]):
...
class SchemaFor501ResponseBodyApplicationJson(
    schemas.DictSchema
):
...
class GEtCovidReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def g_et_covid_report(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def g_et_covid_report(
        ...
        return self._g_et_covid_report_oapg(
